...
data1 = pd.read_csv('bllac-d-evpa.csv')
data = pd.DataFrame(data1) #loads first data into df

data2 = pickle.load(open('bllac-d.pkl','rb'))
...
#data = data.drop([407,167,180,189,190,2,9,10,145,344,545]
...
fig1 = plt.figure(1)
plt.plot(data['mjd'],data['mag_src'],'.',markersize=2,color='red')
plt.gca().invert_yaxis()
plt.xlabel('MJD')
plt.ylabel('Magnitude')
plt.errorbar(data['mjd'],data['mag_src'],yerr=data['mag_src_err'],linestyle='none',color='red',elinewidth=0.5)
fig1.align_labels()
plt.savefig('Rfig1', dpi=500)

fig2 = plt.figure(2)
plt.plot(x1,x3,'.',markersize=2,color='red')
plt.xlabel('MJD')
plt.ylabel('Polarisation (%)')
plt.errorbar(x1,x3,yerr=y2,linestyle='none',color='red',elinewidth=0.5)
fig2.align_labels()
plt.savefig('Rfig2', dpi=500)

fig3, (ax1, ax2) = plt.subplots(2, sharex=True, figsize=(7,5))
ax1.plot(data['mjd'],data['mag_src'],'.',markersize=2,color='red')
ax1.invert_yaxis()
ax1.set(ylabel='Magnitude')
ax1.errorbar(data['mjd'],data['mag_src'],yerr=data['mag_src_err'],linestyle='none',color='red',elinewidth=0.5)

ax2.plot(x1,x3,'.',markersize=3,color='red')
ax2.set(xlabel='MJD')
ax2.set(ylabel='Polarisation (%)')
ax2.errorbar(x1,x3,yerr=y2,linestyle='none',color='red',elinewidth=0.5)
fig3.tight_layout()
fig3.align_labels()
plt.savefig('Rfig3', dpi=500)
...
plt.figure(4)
plt.plot(x3,x2,'.',markersize=2,color='red')
plt.errorbar(x3,x2,xerr=y2,yerr=y1,linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
P1, C1 = ss.spearmanr(x3,x2)
plt.title('C='+str(round((C1),2))+', P='+str(round((P1),2))+'',fontsize=14)
plt.xlabel('Polarisation (%)',fontsize=14)
plt.ylabel('Magnitude',fontsize=14)
plt.savefig('Rfig4', dpi=500)

fig5 = plt.figure(figsize=(9,9))
plt.subplot(331)
plt.plot(x3[0:n1],x2[0:n1],'.',markersize=2,color='red')
plt.errorbar(x3[0:n1],x2[0:n1],xerr=y2[0:n1],yerr=y1[0:n1],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
...
plt.subplot(332)
plt.plot(x3[n1:n2],x2[n1:n2],'.',markersize=2,color='red')
plt.errorbar(x3[n1:n2],x2[n1:n2],xerr=y2[n1:n2],yerr=y1[n1:n2],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
P3, C3 = ss.spearmanr(x3[n1:n2],x2[n1:n2])
plt.title('C='+str(round((C3),2))+', P='+str(round((P3),2))+'',fontsize=12)

plt.subplot(333)
plt.plot(x3[n2:n3],x2[n2:n3],'.',markersize=2,color='red')
plt.errorbar(x3[n2:n3],x2[n2:n3],xerr=y2[n2:n3],yerr=y1[n2:n3],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
P4, C4 = ss.spearmanr(x3[n2:n3],x2[n2:n3])
plt.title('C='+str(round((C4),2))+', P='+str(round((P4),2))+'',fontsize=12)

plt.subplot(334)
plt.plot(x3[n3:n4],x2[n3:n4],'.',markersize=2,color='red')
plt.errorbar(x3[n3:n4],x2[n3:n4],xerr=y2[n3:n4],yerr=y1[n3:n4],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
...
plt.subplot(335)
plt.plot(x3[n4:n5],x2[n4:n5],'.',markersize=2,color='red')
plt.errorbar(x3[n4:n5],x2[n4:n5],xerr=y2[n4:n5],yerr=y1[n4:n5],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
...
plt.subplot(336)
plt.plot(x3[n5:n6],x2[n5:n6],'.',markersize=2,color='red')
plt.errorbar(x3[n5:n6],x2[n5:n6],xerr=y2[n5:n6],yerr=y1[n5:n6],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
...
plt.subplot(337)
plt.plot(x3[n6:n7],x2[n6:n7],'.',markersize=2,color='red')
plt.errorbar(x3[n6:n7],x2[n6:n7],xerr=y2[n6:n7],yerr=y1[n6:n7],linestyle='none',color='red',elinewidth=0.5)
plt.gca().invert_yaxis()
...
high_evpa_errs.to_csv('high_errs_R.csv')
...
EVPA_data.to_csv('EVPA_dataR.csv')
...
plt.figure(6)
plt.plot(EVPA_data['mjd'],EVPA_data['EVPA180'],'.',markersize=2,color='red')
plt.xlabel('MJD',fontsize=14)
plt.ylabel('EVPA ($^\circ$)',fontsize=14)
plt.errorbar(EVPA_data['mjd'],EVPA_data['EVPA180'],yerr=EVPA_data['EVPA_err'],linestyle='none',color='red',elinewidth=0.5)
plt.savefig('Rfig6', dpi=500)
...
ax[0,0].hist(abs(a2),49,color='red',edgecolor='black')
...
ax[0,1].hist(abs(a2),49,color='red',edgecolor='black')
...
ax[0,2].hist(abs(a2),49,color='red',edgecolor='black')
...
ax[0,3].hist(abs(a2),49,color='red',edgecolor='black')
...
ax[1,0].hist(abs(a1),49,color='red',edgecolor='black')
...
ax[1,1].hist(abs(a1),49,color='red',edgecolor='black')
...
ax[1,2].hist(abs(a1),49,color='red',edgecolor='black')
...
ax[1,3].hist(abs(a1),49,color='red',edgecolor='black')
...
ax[2,2].hist(abs(a3),49,color='red',edgecolor='black')
...
ax[2,3].hist(abs(a3),49,color='red',edgecolor='black')
...
ax[3,2].hist(abs(a4),49,color='red',edgecolor='black')
...
ax[3,3].hist(abs(a4),49,color='red',edgecolor='black')
...
ax1.plot(X1,Y1,'.',markersize=2,color='red')
...
ax2.plot(X2,Y2,'.',markersize=2,color='red')
ax2.errorbar(X2,Y2,Z2,linestyle='none',color='red',elinewidth=0.5)
ax2.plot(moving_average(X2,av_size),moving_average(Y2,av_size),color='purple',linewidth=0.5)
ax2.set(xlabel='MJD')
ax2.set(ylabel='EVPA ($^\circ$)')
fig8.tight_layout()
fig8.align_labels()
plt.savefig('Rfig8', dpi=750) 
...
plt.figure(9)
plt.title('Camera d',fontsize=14)
